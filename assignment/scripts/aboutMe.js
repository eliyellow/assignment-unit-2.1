...
let fullName = 'Eli, Brown';
fullName = 'Eli, Brown';
console.log('Eli, Brown');
...
let introduction = 'Eli, Brown';
introduction = 9;
let introduction = `My name is ${fullName} and ${luckyNumber}`
